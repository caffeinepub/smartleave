      ...
      <section className="bg-gradient-to-b from-card to-background border-b border-border">
        <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16 text-center">
          ...
          <p className="mt-4 text-base sm:text-lg text-muted-foreground max-w-xl mx-auto">
            QuikLiv analyzes traffic patterns to suggest the best times to leave
            — so you arrive stress-free.
          </p>
        </div>
      </section>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        {result && (
          <div id="results-section" className="space-y-8">
            ...
            <div className="flex items-center gap-2 px-4 py-3 rounded-xl bg-card border border-border text-sm">
            ...
            {hasNightTravel && (
              ...
              >
                ...
                <p className="text-sm">
                  <strong>Night travel (12am–5am):</strong> Traffic is typically
                  minimal. Expect smooth roads with very few delays.
                </p>
              </div>
            )}
              ...
              {isOfficeHours ? (
                ...
                <>
                  ...
                  {displayedDepartureWindows.length === 0 ? (
                    ...
                    >
                      No departure times fall within office hours (8am–6pm). Try
            ...
            <section data-ocid="custom_dep.section">
              ...
              <div className="bg-card border border-border rounded-2xl p-5 space-y-4">
                <p className="text-sm text-muted-foreground">
                  Enter a custom time to see how traffic looks and whether it's
                  a good choice.
                </p>
                ...
                {customDepResult && (
                  <div data-ocid="custom_dep.result.card" className="space-y-4">
                    ...
                    >
                      <div className="border border-border rounded-xl p-4 space-y-3">
                        ...
                        <div className="flex items-center gap-3 flex-wrap">
                          ...
                          <TrafficBadge level={customRetResult.trafficLevel} />
                          <span className="text-xs text-muted-foreground ml-auto">
              ...
              <div className="bg-card border border-border rounded-2xl p-5">
                ...
                <div className="mt-4 pt-4 border-t border-border">
                  <p className="text-sm text-muted-foreground">
                    Current traffic:{" "}
                    <TrafficBadge
                      level={getTrafficLevel(new Date().getHours(), isWeekend)}
                    />
                  </p>
                </div>
              </div>
