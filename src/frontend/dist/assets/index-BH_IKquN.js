...
const Bike = createLucideIcon("bike", __iconNode$d);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Flag = createLucideIcon("flag", __iconNode$8);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Footprints = createLucideIcon("footprints", __iconNode$7);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
const Locate = createLucideIcon("locate", __iconNode$6);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
async function fetchSuggestions(query) {
  ...
  try {
    ...
    return (data.features || []).map((f) => {
      ...
      const [lon, lat] = ((_a2 = f.geometry) == null ? void 0 : _a2.coordinates) || [0, 0];
    ...
    try {
      ...
      return (data || []).map((item) => {
        ...
        const main = addr.road || addr.suburb || item.display_name.split(",")[0];
        const area = addr.neighbourhood || addr.suburb || addr.quarter || addr.district || addr.county || "";
...
function AddressInput({
  ...
  const justSelectedRef = reactExports.useRef(false);
  ...
  function selectSuggestion(s) {
    ...
    onCoordinatesSelected == null ? void 0 : onCoordinatesSelected(s.lat, s.lon);
    setShowDropdown(false);
    setSuggestions([]);
  }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          ...
          placeholder,
          className: `flex h-10 w-full rounded-md border bg-input px-3 py-2 text-sm text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${rightElement ? "pr-10" : ""} ${error ? "border-destructive" : "border-border"}`
        }
      ),
      rightElement && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute right-2.5 top-1/2 -translate-y-1/2", children: rightElement })
    ] }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-destructive mt-1", children: error }),
    showDropdown && suggestions.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 right-0 top-full mt-1 bg-card border border-border rounded-xl shadow-xl z-50 overflow-hidden", children: suggestions.map((s, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `px-4 py-3 cursor-pointer transition-colors ${i === highlightIdx ? "bg-secondary" : "hover:bg-secondary"}`,
        onMouseDown: (e) => {
          e.preventDefault();
          selectSuggestion(s);
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-medium text-foreground", children: s.displayName }),
          s.subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: s.subtitle })
        ]
      },
      `${s.lat}-${s.lon}-${i}`
    )) })
...
function TrafficBadge$1({ level }) {
  const config = {
    ...
    moderate: {
      label: "Moderate",
      className: "bg-traffic-moderate/20 text-traffic-moderate border-traffic-moderate/30"
    },
    heavy: {
      label: "Heavy",
      className: "bg-traffic-heavy/20 text-traffic-heavy border-traffic-heavy/30"
    }
  };
    ...
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `w-1.5 h-1.5 rounded-full ${level === "low" ? "bg-traffic-low" : level === "moderate" ? "bg-traffic-moderate" : "bg-traffic-heavy"}`
          }
        ),
        c.label
      ]
...
function getReminderLabel(hour) {
  ...
  if (slots.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: "No slots available for this time window."
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3", children: slots.map((slot) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": `${section}.item.${slot.hour - slots[0].hour + 1}`,
      className: `relative flex flex-col gap-2 p-4 rounded-xl border transition-all ${slot.isBest ? "border-brand bg-brand/5 brand-glow" : "border-border bg-card"}`,
      children: [
        slot.isBest && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-2.5 left-1/2 -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-brand text-primary-foreground text-[10px] font-bold px-2 py-0.5 rounded-full whitespace-nowrap", children: "★ BEST" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrafficBadge$1, { level: slot.trafficLevel }),
        slot.isBest && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            "data-ocid": `${section}.set_reminder.button`,
            variant: "outline",
            size: "sm",
            className: `mt-1 gap-1.5 text-xs ${remindedHour === slot.hour ? "text-green-400 border-green-400/40 bg-green-400/10 cursor-not-allowed" : "hover:border-brand hover:text-brand"}`,
            onClick: () => onSetReminder(slot),
            disabled: remindedHour === slot.hour,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-3 h-3" }),
              remindedHour === slot.hour ? "✅ Reminder Set" : `🔔 Remind me at ${getReminderLabel(slot.hour)}`
            ]
          }
        )
      ]
...
function getTrafficMultiplier(level, mode) {
  if (mode === "walk") return 1;
  const multipliers = {
    car: { low: 1, moderate: 1.4, heavy: 2 },
    bike: { low: 1, moderate: 1.1, heavy: 1.2 },
    walk: { low: 1, moderate: 1, heavy: 1 }
  };
  return multipliers[mode][level];
}
function getBaseMinutes(distanceKm, mode) {
  const minutesPerKm = {
    car: 2,
    bike: 4,
    walk: 12
...
function computeTravelMinutes(departureTime, distanceKm, mode, isWeekend) {
...
function delayRiskFromLevel(level) {
  if (level === "heavy") return "high";
  if (level === "moderate") return "medium";
  return "low";
}
function buildReason(label, departureTime, trafficLevel, isNight) {
  if (isNight)
...
function generateDepartureWindows(params) {
  ...
  return offsets.map(({ label, minuteOffset }) => {
    const departure = new Date(
      recommendedDeparture.getTime() + minuteOffset * 60 * 1e3
    );
    ...
    const arrival = new Date(departure.getTime() + travelMins * 60 * 1e3);
...
function getTimelineData(startHour, isWeekend) {
  const slots = [];
  const now2 = /* @__PURE__ */ new Date();
  const base = new Date(now2);
  base.setHours(startHour, 0, 0, 0);
  for (let i = 0; i < 12; i++) {
    const slotTime = new Date(base.getTime() + i * 30 * 60 * 1e3);
...
function generateOfficeHoursSlots(startHour, endHour, distanceKm, mode, isWeekend, tripDate) {
  const slots = [];
  ...
  for (let i = 1; i < slots.length; i++) {
    if (slots[i].trafficMultiplier < slots[bestIdx].trafficMultiplier || slots[i].trafficMultiplier === slots[bestIdx].trafficMultiplier && slots[i].travelMinutes < slots[bestIdx].travelMinutes) {
      bestIdx = i;
    }
  }
...
function generateLongDistanceWindows(params) {
  ...
  const windows = slots.map(({ label, hour }) => {
    const departure = /* @__PURE__ */ new Date(
...
async function fetchWithTimeout$1(url, timeoutMs = 5e3) {
...
async function getLocationViaIP() {
  const apis = [
    async () => {
      const r2 = await fetchWithTimeout$1("https://ipapi.co/json/");
    ...
    async () => {
      const r2 = await fetchWithTimeout$1(
    ...
    async () => {
      const r2 = await fetchWithTimeout$1("https://ipwho.is/");
      const d = await r2.json();
      if (d.latitude && d.longitude)
        return { lat: d.latitude, lon: d.longitude };
      return null;
...
function useLocationDetect() {
  const [status, setStatus] = reactExports.useState("idle");
  function detect(setAddress, onToast) {
    setStatus("detecting");
    const tryIP = async () => {
    ...
    "span",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: `w-2 h-2 rounded-full ${level === "low" ? "bg-traffic-low" : level === "moderate" ? "bg-traffic-moderate" : "bg-traffic-heavy"}`
          }
        ),
        c.label
      ]
...
function DelayBadge({ risk }) {
  ...
  const c = config[risk];
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-xs font-medium ${c.className}`, children: c.label });
}
function DepartureCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      className: `relative flex flex-col gap-3 p-5 rounded-xl border card-hover ${isRec ? "border-brand bg-card brand-glow" : "border-border bg-card"}`,
      children: [
        isRec && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-3 left-1/2 -translate-x-1/2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "bg-brand text-primary-foreground text-xs font-bold px-3 py-1 rounded-full", children: "★ Best Option" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              className: `text-sm font-semibold ${isRec ? "text-brand" : "text-muted-foreground"}`,
              children: w.label
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TrafficBadge, { level: w.trafficLevel })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-3xl font-bold text-foreground", children: formatTime(w.departureTime) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 bg-secondary/50 rounded-lg px-2.5 py-1.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(DelayBadge, { risk: w.delayRisk })
        ] }),
        isRec && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs italic text-muted-foreground border-t border-border pt-3", children: w.reason }),
        showReminder && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            "data-ocid": `departure.${w.label.toLowerCase()}.set_reminder`,
            variant: isReminded ? "secondary" : "outline",
            size: "sm",
            className: `mt-auto gap-2 ${isReminded ? "text-brand border-brand/40 bg-brand/10" : "hover:border-brand hover:text-brand"}`,
...
function ReminderBanner({
  ...
  const [customMins, setCustomMins] = reactExports.useState("15");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 flex items-center justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-5 h-5 shrink-0 animate-pulse" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold leading-snug", children: alert.message })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pb-3 flex flex-wrap items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium opacity-80 mr-1", children: "Snooze:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onClick: () => setShowCustom((v2) => !v2),
              className: `px-3 py-1 rounded-full text-xs font-semibold transition-colors ${showCustom ? "bg-white/40" : "bg-white/20 hover:bg-white/30"}`,
              children: "Custom"
            }
          ),
          showCustom && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
...
async function fetchRouteDistance(originCoords, destCoords, _mode) {
  var _a2, _b2;
  ...
  for (const url of osrmUrls) {
    try {
      ...
      if (!res.ok) continue;
      const data = await res.json();
      const meters = (_b2 = (_a2 = data == null ? void 0 : data.routes) == null ? void 0 : _a2[0]) == null ? void 0 : _b2.distance;
      if (meters) {
        return {
          distanceKm: Math.round(meters / 1e3 * 10) / 10,
          isApproximate: false
        };
      }
    } catch {
...
function App() {
  ...
  const [mode, setMode] = reactExports.useState("car");
  const [isRoundTrip, setIsRoundTrip] = reactExports.useState(false);
  const [isOfficeHours, setIsOfficeHours] = reactExports.useState(false);
  const [tripDate, setTripDate] = reactExports.useState(() => {
    const d = /* @__PURE__ */ new Date();
    return `${d.getFullYear()}-${String(d.getMonth() + 1).padStart(2, "0")}-${String(d.getDate()).padStart(2, "0")}`;
  });
  const [timeAtDest] = reactExports.useState("2");
  const [isWeekend, setIsWeekend] = reactExports.useState(() => {
  ...
  const [usingApproximate, setUsingApproximate] = reactExports.useState(false);
  const [remindedGoingHour, setRemindedGoingHour] = reactExports.useState(
    null
  );
  const [remindedReturnHour, setRemindedReturnHour] = reactExports.useState(
    null
  );
  const { status: locStatus, detect: detectLocation } = useLocationDetect();
  const [errors, setErrors] = reactExports.useState({});
  const [result, setResult] = reactExports.useState(null);
  const [customDepTime, setCustomDepTime] = reactExports.useState("");
  const [customDepResult, setCustomDepResult] = reactExports.useState(null);
  const [customRetTime, setCustomRetTime] = reactExports.useState("");
  const [customRetResult, setCustomRetResult] = reactExports.useState(null);
  const [reminders, setReminders] = reactExports.useState([]);
  const [activeAlert, setActiveAlert] = reactExports.useState(null);
  const firedReminders = reactExports.useRef(/* @__PURE__ */ new Set());
  const reminderInterval = reactExports.useRef(null);
  const [timelineKey, setTimelineKey] = reactExports.useState(0);
  reactExports.useEffect(() => {
    ...
    reminderInterval.current = setInterval(() => {
      ...
      for (const r2 of reminders) {
        const key = `${r2.type}::${r2.windowLabel}::${r2.departureTime.getTime()}`;
        if (firedReminders.current.has(key)) continue;
        const diffMs = r2.departureTime.getTime() - now2.getTime();
        ...
        if (diffMins <= 15 && diffMins > 14) {
          ...
          setActiveAlert({
            reminderLabel: key,
            message: `Time to leave! Your ${r2.type === "return" ? "return " : ""}departure (${r2.windowLabel}) is in ${minsLeft} minute${minsLeft !== 1 ? "s" : ""}.`
          });
          return;
        }
      }
  ...
  function handleSnooze(minutes) {
    ...
    setReminders(
      (prev) => prev.map((r2) => {
        const rKey = `${r2.type}::${r2.windowLabel}::${r2.departureTime.getTime()}`;
        if (rKey !== key) return r2;
        return {
          ...r2,
          departureTime: new Date(r2.departureTime.getTime() + minutes * 6e4)
        };
      })
    );
    firedReminders.current.delete(key);
    setActiveAlert(null);
    ue.success(`Reminder snoozed for ${minutes} minutes`, {
  ...
  async function handlePlan() {
    ...
    const base = /* @__PURE__ */ new Date(`${tripDate}T00:00:00`);
    const now2 = /* @__PURE__ */ new Date();
    const isToday = base.toDateString() === now2.toDateString();
    const arrivalDate = isToday ? new Date(now2.getTime() + 2 * 3600 * 1e3) : new Date(base.getTime() + 12 * 3600 * 1e3);
    const LONG_DISTANCE_KM = 20;
    const isLongDistance = distKm >= LONG_DISTANCE_KM;
    const departureWindows = isLongDistance ? generateLongDistanceWindows({
    ...
    let returnWindows = null;
    if (isRoundTrip) {
      let returnDeparture;
      if (isOfficeHours) {
        returnDeparture = /* @__PURE__ */ new Date(`${tripDate}T18:00:00`);
      } else {
        const hoursAtDest = Number.parseFloat(timeAtDest) || 2;
        const recWindow = isLongDistance ? departureWindows.find((w) => w.isBest) ?? departureWindows[0] : departureWindows[1];
        returnDeparture = new Date(
          recWindow.arrivalTime.getTime() + hoursAtDest * 3600 * 1e3
        );
      }
      returnWindows = isLongDistance ? generateLongDistanceWindows({
        targetArrivalTime: new Date(
          returnDeparture.getTime() + 60 * 60 * 1e3
        ),
        distanceKm: distKm,
        mode,
        isWeekend
    ...
    const timeline = getTimelineData(now2.getHours(), isWeekend);
    ...
    setTimeout(() => {
      var _a2;
      (_a2 = document.getElementById("results-section")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
    }, 100);
  }
  function handleSetReminder(w, type) {
    setReminders((prev) => [
      ...prev,
      { windowLabel: w.label, departureTime: w.departureTime, type }
    ]);
    ue.success(`Reminder set for ${formatTime(w.departureTime)}`, {
      description: "We'll alert you 15 minutes before your departure.",
      icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "w-4 h-4" })
    });
  }
  function handleSetReminderForSlot(slot, type) {
    if ("Notification" in window) {
      Notification.requestPermission().then((permission) => {
        if (permission === "granted") {
          const tripDateObj = /* @__PURE__ */ new Date(
            `${tripDate}T${String(slot.hour).padStart(2, "0")}:00:00`
          );
          const reminderTime2 = new Date(tripDateObj.getTime() - 15 * 60 * 1e3);
          const msUntil = reminderTime2.getTime() - Date.now();
          if (msUntil > 0) {
            setTimeout(() => {
    ...
    ue.success(`🔔 Reminder set for ${timeStr}`);
  }
  function isReminded(w, type) {
    return reminders.some((r2) => r2.windowLabel === w.label && r2.type === type);
  }
  const transportModes = [
    { id: "car", label: "Car", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "w-4 h-4" }) },
    { id: "bike", label: "Bike", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Bike, { className: "w-4 h-4" }) },
    { id: "walk", label: "Walk", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Footprints, { className: "w-4 h-4" }) }
  ];
  const modeLabels = {
    car: "Car",
    bike: "Bike",
  ...
  const timelineColor = (level) => {
    if (level === "heavy") return "bg-traffic-heavy";
    if (level === "moderate") return "bg-traffic-moderate";
    return "bg-traffic-low";
  };
  const hasNightTravel = result == null ? void 0 : result.departureWindows.some((w) => w.isNightTravel);
  const bestDuration = result ? Math.min(...result.departureWindows.map((w) => w.travelMinutes)) : 0;
  const worstDuration = result ? Math.max(...result.departureWindows.map((w) => w.travelMinutes)) : 0;
  function isOfficeHourSlot(slot) {
    const h = slot.time.getHours();
    return h >= 8 && h < 18;
  }
  const displayedDepartureWindows = result ? isOfficeHours ? result.departureWindows.filter((w) => {
    const h = w.departureTime.getHours();
    return h >= 8 && h < 18;
  }) : result.departureWindows : [];
  const displayedReturnWindows = (result == null ? void 0 : result.returnWindows) ? isOfficeHours ? result.returnWindows.filter((w) => {
    const h = w.departureTime.getHours();
    return h >= 8 && h < 18;
  }) : result.returnWindows : null;
  function evaluateCustomTime(timeStr, _section) {
    if (!result || !timeStr) return null;
    const [hStr, mStr] = timeStr.split(":");
    const hour = Number.parseInt(hStr, 10);
    const minute = Number.parseInt(mStr, 10);
    const dt = /* @__PURE__ */ new Date(`${tripDate}T00:00:00`);
    ...
    const verdict = trafficLevel === "low" ? "good" : trafficLevel === "moderate" ? "fair" : "bad";
    const reasons = {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-sans", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 h-16 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-lg bg-brand flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-4.5 h-4.5 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-lg font-bold tracking-tight text-foreground", children: "QuikLiv" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground hidden sm:block", children: "Know Before You Go" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          onClick: () => setIsWeekend((v2) => !v2),
          className: `flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold border transition-colors ${isWeekend ? "bg-brand/20 text-brand border-brand/40" : "bg-secondary text-muted-foreground border-border"}`,
          children: [
            isWeekend ? /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "w-3.5 h-3.5" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Sun, { className: "w-3.5 h-3.5" }),
            isWeekend ? "Weekend" : "Weekday"
          ]
        }
      ) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "bg-gradient-to-b from-card to-background border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-12 sm:py-16 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl sm:text-5xl font-bold text-foreground leading-tight", children: [
        "Find Your ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand", children: "Perfect" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        "Departure Time"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base sm:text-lg text-muted-foreground max-w-xl mx-auto", children: "QuikLiv analyzes traffic patterns to suggest the best times to leave — so you arrive stress-free." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "max-w-4xl mx-auto px-4 py-8 space-y-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Plan Your Trip" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-foreground font-medium flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-3.5 h-3.5 text-brand" }),
                  " Origin"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  AddressInput,
                  {
                    ...
                    onCoordinatesSelected: (lat, lon) => setOriginCoords({ lat, lon }),
                    ...
                    rightElement: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "button",
                      {
                        ...
                        children: locStatus === "detecting" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "⏳" }) : locStatus === "success" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm", children: "✅" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Locate, { className: "w-4 h-4" })
                      }
                    )
                  }
                )
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-foreground font-medium flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { className: "w-3.5 h-3.5 text-brand" }),
                  " Destination"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  AddressInput,
                  {
                    ...
                    onCoordinatesSelected: (lat, lon) => setDestCoords({ lat, lon }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-foreground font-medium", children: "Transport Mode" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 flex-wrap", children: transportModes.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  "data-ocid": `transport.${m.id}.toggle`,
                  onClick: () => setMode(m.id),
                  className: `flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border transition-all ${mode === m.id ? "bg-brand text-primary-foreground border-brand shadow-md" : "bg-secondary text-muted-foreground border-border hover:border-brand/50 hover:text-foreground"}`,
                  children: [
                    m.icon,
                    m.label
                  ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-4 items-end", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-foreground font-medium", children: "Trip Type" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex rounded-xl border border-border overflow-hidden", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                      ...
                      className: `px-4 py-2.5 text-sm font-semibold transition-colors ${!isRoundTrip ? "bg-brand text-primary-foreground" : "bg-secondary text-muted-foreground hover:text-foreground"}`,
                      children: "One-Way"
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-foreground font-medium flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-3.5 h-3.5 text-brand" }),
                  " Office Hours"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    ...
                    onClick: () => setIsOfficeHours((v2) => !v2),
                    className: `flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold border transition-all ${isOfficeHours ? "bg-amber-500/20 text-amber-400 border-amber-500/40" : "bg-secondary text-muted-foreground border-border hover:border-amber-500/40 hover:text-foreground"}`,
                    children: [
                ...
                isOfficeHours && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-amber-400 flex items-center gap-1", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Label, { className: "text-foreground font-medium flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Calendar, { className: "w-3.5 h-3.5 text-brand" }),
                " Trip Date"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "input",
      ...
      result && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "results-section", className: "space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 px-4 py-3 rounded-xl bg-card border border-border text-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 text-brand shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground truncate", children: origin }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-4 h-4 text-muted-foreground shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Flag, { className: "w-4 h-4 text-brand shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium text-foreground truncate", children: destination })
        ] }),
        hasNightTravel && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Moon, { className: "w-5 h-5 shrink-0 mt-0.5" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Night travel (12am–5am):" }),
                " Traffic is typically minimal. Expect smooth roads with very few delays."
              ] })
            ]
          }
        ),
        usingApproximate && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Showing approximate times — route estimation used" })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "departure.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowRight, { className: "w-5 h-5 text-brand" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Departure — Going" }),
            isOfficeHours && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-amber-400 flex items-center gap-1 ml-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-3 h-3" }),
              " Office Hours (8am–6pm)"
            ] })
          ] }),
          isOfficeHours ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            OfficeHoursGrid,
            {
              ...
              onSetReminder: (slot) => handleSetReminderForSlot(slot, "going")
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            result.isLongDistance && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-xl border border-brand/30 bg-brand/10 text-brand text-sm mb-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "🛣️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Long distance trip — showing best departure windows by time of day" })
            ] }),
            displayedDepartureWindows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                "data-ocid": "departure.empty_state",
                className: "p-6 rounded-xl border border-amber-500/30 bg-amber-500/10 text-amber-300 text-sm text-center",
                children: "No departure times fall within office hours (8am–6pm). Try adjusting your trip date."
              }
            ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: `grid grid-cols-1 gap-4 ${result.isLongDistance ? "sm:grid-cols-2" : "sm:grid-cols-3"}`,
                children: displayedDepartureWindows.map((w) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  DepartureCard,
                  {
                    window: w,
                    onSetReminder: () => handleSetReminder(w, "going"),
                    isReminded: isReminded(w, "going"),
                    showReminder: w.label === "Recommended" || w.isBest === true
                  },
                  w.label
                ))
              }
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "custom_dep.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 text-brand" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Check Your Departure Time" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-5 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Enter a custom time to see how traffic looks and whether it's a good choice." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-end", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "label",
                  {
                    ...
                    children: "Your preferred departure time"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  onClick: () => setCustomDepResult(
                    evaluateCustomTime(customDepTime)
                  ),
            ...
            customDepResult && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "custom_dep.result.card", className: "space-y-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-xl p-4 space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-3xl font-bold text-foreground", children: [
                    customDepResult.time.split(":").map(
                      (p, i) => i === 0 ? String(
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "span",
                    {
                      ...
                      children: [
                        customDepResult.verdict === "good" ? "✅" : customDepResult.verdict === "fair" ? "⚠️" : "❌",
                        " ",
                        customDepResult.verdict === "good" ? "Good Option" : customDepResult.verdict === "fair" ? "Fair Option" : "Not Recommended"
                      ]
                    }
                  )
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Traffic:" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TrafficBadge, { level: customDepResult.trafficLevel }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground ml-auto", children: [
                    "~",
                    customDepResult.travelMinutes,
                    " min travel"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground italic", children: customDepResult.reason })
              ] }),
              displayedDepartureWindows.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "★ Best Available Options" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [...displayedDepartureWindows].sort((a, b) => a.travelMinutes - b.travelMinutes).slice(0, 2).map((w, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                        idx === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand text-xs font-bold", children: "★ Best" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: formatTime(w.departureTime) })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TrafficBadge, { level: w.trafficLevel }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "timeline.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 text-brand" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Traffic Timeline — Next 6 Hours" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-5 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5 mb-1 h-4", children: result.timeline.map((slot, _i2) => {
                const recWindow = result.departureWindows[1];
                const slotEnd = new Date(
                  slot.time.getTime() + 30 * 60 * 1e3
                );
                const isMarked = recWindow.departureTime >= slot.time && recWindow.departureTime < slotEnd;
                return /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "flex-1 flex items-end justify-center",
                    children: isMarked && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[9px] font-bold text-brand leading-none", children: "▼" }) })
                  },
                  slot.label
                );
              }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: result.timeline.map((slot, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                ...
                isOfficeHours && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 flex gap-0.5 rounded-lg overflow-hidden pointer-events-none", children: result.timeline.map((slot) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: `flex-1 h-10 rounded-sm transition-opacity ${isOfficeHourSlot(slot) ? "bg-amber-400/25 ring-1 ring-inset ring-amber-400/40" : "bg-transparent"}`
                  },
                  `oh-${slot.label}`
                )) })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-0.5 mt-1", children: result.timeline.map((slot, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 text-center", children: i % 2 === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-muted-foreground", children: slot.label }) }, slot.label)) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-5 flex-wrap pt-2 border-t border-border", children: [
              [
                { level: "low", label: "Low", cls: "bg-traffic-low" },
                {
                  level: "moderate",
                  label: "Moderate",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-3 h-3 rounded-sm ${item.cls}` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: item.label })
              ] }, item.level)),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-brand text-xs", children: "▼" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Recommended departure" })
              ] }),
              isOfficeHours && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-3 h-3 rounded-sm bg-amber-400/40 ring-1 ring-amber-400/60" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-amber-400", children: "Office Hours" })
              ] })
            ] })
          ] })
        ] }),
        result.isRoundTrip && result.returnWindows && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "return.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(RotateCcw, { className: "w-5 h-5 text-brand" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Return — Coming Back" }),
            isOfficeHours && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-amber-400 flex items-center gap-1 ml-auto", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Briefcase, { className: "w-3 h-3" }),
              " Office Hours (8am–6pm)"
            ] })
          ...
          isOfficeHours ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            OfficeHoursGrid,
            {
              ...
              onSetReminder: (slot) => handleSetReminderForSlot(slot, "return")
            }
          ) : displayedReturnWindows && displayedReturnWindows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              "data-ocid": "return.empty_state",
              className: "p-6 rounded-xl border border-amber-500/30 bg-amber-500/10 text-amber-300 text-sm text-center",
              children: "No return times fall within office hours (8am–6pm). Try adjusting your trip date."
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: `grid grid-cols-1 gap-4 ${result.isLongDistance ? "sm:grid-cols-2" : "sm:grid-cols-3"}`,
              children: (displayedReturnWindows ?? result.returnWindows).map(
        ...
        result.isRoundTrip && result.returnWindows && /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "custom_ret.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "w-5 h-5 text-brand" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Check Your Return Time" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-5 space-y-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Enter a custom time to evaluate traffic for your return journey." }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 items-end", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "label",
                  {
                    ...
                    className: "text-xs text-muted-foreground mb-1 block",
                    children: "Your preferred return time"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  ...
                  onClick: () => setCustomRetResult(
                    evaluateCustomTime(customRetTime)
                  ),
            ...
            customRetResult && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-xl p-4 space-y-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-3xl font-bold text-foreground", children: [
                        customRetResult.time.split(":").map(
                          (p, i) => i === 0 ? String(
                            Number.parseInt(p) % 12 || 12
                          ).padStart(2, "0") : p
                        ).join(":"),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        "span",
                        {
                          ...
                          children: [
                            customRetResult.verdict === "good" ? "✅" : customRetResult.verdict === "fair" ? "⚠️" : "❌",
                            " ",
                            customRetResult.verdict === "good" ? "Good Option" : customRetResult.verdict === "fair" ? "Fair Option" : "Not Recommended"
                          ]
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Traffic:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TrafficBadge, { level: customRetResult.trafficLevel }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground ml-auto", children: [
                        "~",
                        customRetResult.travelMinutes,
                        " min travel"
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground italic", children: customRetResult.reason })
                  ] }),
                  displayedReturnWindows && displayedReturnWindows.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold text-muted-foreground uppercase tracking-wide", children: "★ Best Available Options" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: [...displayedReturnWindows].sort(
                      (a, b) => a.travelMinutes - b.travelMinutes
                    ).slice(0, 2).map((w, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
                      {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "summary.section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-5 h-5 text-brand" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-xl font-bold text-foreground", children: "Route Summary" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl p-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-px bg-border rounded-xl overflow-hidden", children: [
              {
                label: "Distance",
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground uppercase tracking-wide", children: item.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-bold text-foreground", children: item.value }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: item.sub })
                ]
              },
              item.label
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 pt-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
              "Current traffic:",
              " ",
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                TrafficBadge,
                {
                  level: getTrafficLevel((/* @__PURE__ */ new Date()).getHours(), isWeekend)
                }
              )
            ] }) })
          ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border bg-card mt-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded bg-brand flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "w-3.5 h-3.5 text-primary-foreground" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground", children: "QuikLiv" })
      ] }),
...
Service({
  "deleteTrip": Func([Nat], [], []),
  "getAllTrips": Func([], [Vec(Trip)], ["query"]),
  "getTrip": Func([Nat], [Trip], ["query"]),
  "saveTrip": Func(
    [Text, Text, TripMode, Nat, Bool],
    [Nat],
    []
  ),
  "updateTrip": Func(
    [Nat, Text, Text, TripMode, Nat, Bool],
    [],
    []
  )
});
